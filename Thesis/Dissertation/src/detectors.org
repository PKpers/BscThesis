...
Appart from position and momentum measurements, it is crucial to have information regarding the energy of the particles that are  produced in the LHC colisions. In CMS, this information is retrieved from particle  interactions with matter at the calorimeters. Effectivelly, the particles that are stable enough to reach the detector undecayed, are either leptons, photons, or hadrons(bound states of quarqs). The interactions that take place between electrons, phtons and matter are of electromagnetic nature, while the interactions between hadrons(charged or neutral) and matter are strong interactions. Thus, there are two types of calorimeters at CMS. At the innermost layer, is located the Electromagnetic Calorimeter(ECAL), which measures the energy of photons and electrons. The Hadron calorimeter(HCAL) is located at the outer shells of the calorimeters section.  
