...
\begin{frame}[label={sec:orgb5d941d}]{Fit based approach: Fitting}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[h]
\centering
...
\begin{frame}[label={sec:orgacc494e}]{Fit based approach: Fitting}
...
\begin{frame}[label={sec:org3d55f2b}]{Fit based approach: Signal from background separation}
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgb012711}]{Fit based approach: Signal from background separation}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orga2a6a22}]{BDT approach: Feature space}
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org072c425}]{BDT approach: Feature space}
\begin{figure}[h!]
\centering
...
\begin{frame}[label={sec:orgb532fec}]{BDT approach: The model}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org601b92e}]{BDT approach: Application}
...
\begin{frame}[label={sec:orga01a960}]{BDT approach: Application}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[h]
\centering
...
\begin{frame}[label={sec:orgda68968}]{BDT approach: Application}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[h]
\centering
...
\begin{frame}[label={sec:org4dd8c9f}]{BDT approach: Signal from background separation}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgc9bfe49}]{BDT approach: Signal from background separation}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org14fc6f8}]{Synopsis}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\label{sec:orgda467da}
\begin{frame}[label={sec:org899fca1}]{Search for heavy \(Y \rightarrow XX\)}
We will study the following smearing cases:\newline
...
\begin{frame}[label={sec:orge654160}]{Fit based approach: Signal Fitting}
...
\begin{frame}[label={sec:org3220fb3}]{Fit based approach: Signal Fitting}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[h]
\centering
...
\begin{frame}[label={sec:orged5a8f6}]{Fit based approach: Signal Fitting}
\begin{figure}[h]
\centering
...
\begin{frame}[label={sec:org71521c2}]{Fit based approach: Signal Fitting}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[h]
\centering
...
\begin{frame}[label={sec:org144a50e}]{Fit based approach: Signal Fitting}
\begin{figure}[h]
\centering
...
\begin{frame}[label={sec:org47bf5f2}]{Fit based approach: Signal from background separation}
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org84d9436}]{Fit based approach: Signal from background separation}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge372f3c}]{BDT approach: Feature space}
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orga9e204d}]{BDT approach: Feature space}
\begin{figure}[h!]
\centering
...
\begin{frame}[label={sec:orga4ba308}]{BDT approach: The model}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
\item Trained with approximately 3K events
...
\begin{frame}[label={sec:org245c705}]{BDT approach: Application}
Feed the application set to the BDT --> BDT plots
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[h]
...
\begin{frame}[label={sec:orge85ea32}]{BDT approach: Application}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[h]
\centering
...
\begin{frame}[label={sec:org933d433}]{BDT approach: Application}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[h]
\centering
...
\begin{frame}[label={sec:org3df8f87}]{BDT approach: Application}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[h]
\centering
...
\begin{frame}[label={sec:org3f19e6c}]{BDT approach: Signal from background separation}
\alert{Where should we place the cut?}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5243d9d}]{BDT approach: Signal from background separation}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orga81df4e}]{Synopsis}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\section{Results}
\label{sec:org7654677}
\begin{frame}[label={sec:org2357d4b}]{Results}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org9e65609}]{Fit based approach: Background Fitting}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org579beaf}]{Search for heavy \(Y \rightarrow XX\)}
We will study the following smearing cases:\newline
\begin{columns}
\begin{column}{0.5\columnwidth}
Medium to extreme cases 
