...
Pt1_sig.GetYaxis().SetRangeUser(0, 900)
Pt1_sig.GetYaxis().SetLabelSize(0.04)
Pt1_sig.GetYaxis().SetTitleSize(0.04)
...
Pt2_sig.GetYaxis().SetRangeUser(0, 900)
Pt2_sig.GetYaxis().SetLabelSize(0.045)
Pt2_sig.GetYaxis().SetTitleSize(0.045)
...
DEta_sig.GetYaxis().SetLabelSize(0.05)
DEta_sig.GetYaxis().SetTitleSize(0.05)
...
# Plot the legend
DEta_legend = ROOT.TLegend(0.3, 0.65, 0.75, 0.8)
...
DPhi_sig.GetYaxis().SetLabelSize(0.05)
DPhi_sig.GetYaxis().SetTitleSize(0.05)
...
DR_sig.GetYaxis().SetLabelSize(0.05)
DR_sig.GetYaxis().SetTitleSize(0.05)
...
# Plot the legend
DR_legend = ROOT.TLegend(0.45, 0.73, 0.6, 0.83)
