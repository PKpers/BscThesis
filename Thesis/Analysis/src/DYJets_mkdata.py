...
def is_dimuon(evnt_ids):
    ...
    It returns
    True:  if the event has exactly two muons
    False: otherwise
    '''
...
if __name__=='__main__':
    ...
    inFileName=inDir+"/analysisTree_hadd1of15.root";#read the root file
    treeName="tree";
    ...
    for entry in tree:
        ...
        dimuon, id_mup, id_mun = is_dimuon(evnt_id)
