import ROOT
import sys
from plots import set_axes_title, PlotHist, create_legend, add_Header, PlotHist2, set_markerstyle
import matplotlib
...
input_dir = "/home/kpapad/UG_thesis/tutorial_scripts/MachineLearning/RFiles/Predictions/"
treeName = "myTree"
infile = sys.argv[1]
#
...
TestingTPR,  TestingFPR = [
    np.array(integrals[0])/100000,
    np.array(integrals[2])/100000
]
TrainingTPR,  TrainingFPR = [
    np.array(integrals[1])/100000,
    np.array(integrals[3])/100000
]
